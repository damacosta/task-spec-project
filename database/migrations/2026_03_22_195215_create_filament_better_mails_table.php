...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($mailsTable, static function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create($eventsTable, static function (Blueprint $table) use ($mailModel): void {
            $table->id();
        ...
        Schema::create($polymorphTable, static function (Blueprint $table) use ($mailModel): void {
            $table->id();
        ...
        Schema::create($attachmentsTable, static function (Blueprint $table) use ($mailModel): void {
            $table->id();
            $table->foreignIdFor($mailModel, 'mail_id')
                ->constrained()
                ->cascadeOnDelete();
