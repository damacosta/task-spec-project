...
Modules with prefix `panel-*` (e.g. `panel-admin`) are the **presentation layer**. They own UI concerns: Filament Resources, Pages, Widgets, Livewire components, and Blade views.

## Rule

Domain logic (Actions, Models, DTOs, business rules) belongs in domain modules (`identity`, etc.), never in presentation modules.
