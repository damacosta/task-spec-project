...
return [
    ...
    /*
     * Scramble is used here as an OpenAPI generator only. The portal-docs module owns
     * /docs and calls Scramble::ignoreDefaultRoutes(), so the renderer settings below
     * never take effect.
     */
     ...
     */
    'dev_tools' => [
        'enabled' => env('SCRAMBLE_DEV_TOOLS', env('APP_DEBUG', default: false)),
    ],
