...
namespace He4rt\PanelAdmin\Filament;
...
final class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->monoFont('JetBrains Mono', provider: LocalFontProvider::class)
            ->renderHook(PanelsRenderHook::HEAD_START, fn (): Htmlable => Vite::fonts('jetbrains-mono'))
            ...
            ->plugins([
                ...
                KnowledgeBaseCompanionPlugin::make()
                    ...
                    ->knowledgeBasePanelId($this->panelId->value)
                ...
                FilamentEditProfilePlugin::make()
                    ...
                    ->shouldShowLocaleForm(
                        ...
                        rules: [Rule::enum(Language::class)],
                    )
                    ->shouldShowThemeColorForm(),
                ActivityLogPlugin::make()
                    ->autoContextTracking()
                    ->dashboard(condition: false)
                    ->label('Log')
                    ->pluralLabel('Logs')
                    ->navigationGroup(fn (): string => NavigationGroup::System->getLabel()),
            ])
            ->userMenuItems([
                'profile' => Action::make('profile')
                    ->label(fn (): string => __('user_menu.profile.label'))
