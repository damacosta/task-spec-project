@php use He4rt\PanelAdmin\Filament\Pages\ExternalIdentitiesPage; @endphp
    ...
    @if ($this->identity->external_account_id)
        <x-filament::section>
            ...
            <div class="space-y-4">
                ...
                @php
                    $projectsSyncedAt = $this->identity->metadata->lastSyncAt(
                        \He4rt\Identity\ExternalIdentity\Enums\IdentityCapability::Projects,
                    );
                @endphp
                <div class="flex flex-wrap gap-4 text-xs text-gray-400">
                    @if ($projectsSyncedAt)
                        <span>
                            Projects synced: {{ $projectsSyncedAt->format('M d, Y H:i') }}
                        </span>
                    @endif
                </div>
