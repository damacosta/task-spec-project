...
use He4rt\PanelAdmin\Filament\Pages\ExternalIdentitiesPage;
use He4rt\PanelAdmin\Filament\Pages\ManageExternalIdentityPage;
...
describe('ExternalIdentitiesPage', function (): void {
    ...
    test('shows Manage link for connected identity', function (): void {
        ...
        get(ExternalIdentitiesPage::getUrl())->assertSuccessful()->assertSeeHtml($manageUrl);
    });
