...
use He4rt\Identity\ExternalIdentity\Casts\AsIdentityMetadata;
 ...
 * @property IdentityMetadata $metadata
 ...
 */
#[UseFactory(factoryClass: ExternalIdentityFactory::class)]
...
class ExternalIdentity extends Model
{
    ...
    /**
     * The attributes that should be hidden for serialization and activity logging.
     *
     * @var list<string>
     */
